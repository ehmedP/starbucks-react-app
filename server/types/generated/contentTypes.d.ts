...
export interface ApiGiftCardGiftCard extends Schema.CollectionType {
  ...
  attributes: {
    ...
    gift_sections: Attribute.Relation<
      'api::gift-card.gift-card',
      'manyToMany',
      'api::gift-section.gift-section'
    >;
    amount: Attribute.Enumeration<['Ex:', 'm', 'a', 'b']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiGiftSectionGiftSection extends Schema.CollectionType {
  collectionName: 'gift_sections';
  info: {
    singularName: 'gift-section';
    pluralName: 'gift-sections';
    displayName: 'gift_section';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiHomeSectionHomeSection extends Schema.CollectionType {
...
export interface ApiSocialLinkSocialLink extends Schema.CollectionType {
  ...
  attributes: {
    Social_address_name: Attribute.String;
    Social_address_image: Attribute.Media;
    Social_address_link: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::gift-section.gift-section': ApiGiftSectionGiftSection;
